      ...
      <el-col :xs="8" :sm="6" :md="4" :lg="8">
        <el-form ref="form" :model="device" label-width="100px">
          ...
          <el-form-item label="报警电话">
              <el-input v-model="device.alarmPhone"></el-input>
          </el-form-item>
          <el-form-item label="位置经度">
            <el-input v-model="device.longitude" :disabled="true"></el-input>
          </el-form-item>
          <el-form-item label="位置纬度" >
            <el-input v-model="device.latitude" :disabled="true"></el-input>
          </el-form-item>
          <el-form-item label="安装地址">
            <el-input v-model="device.address" :disabled="true"></el-input>
          </el-form-item>      
          <el-form-item>
...
<script>
import { saveDeviceAlarmPhone } from 'api/device';
export default {
  data() {
    let self = this;
    return {
  ...
  created() {
    ...
    this.device.alarmPhone = curDevice.alarmPhone || '';
  ...
  methods: {
    saveDeviceInfo() {
      let requestParams = {
        deviceNo: this.device.no,
        terminalNo: this.device.terminalNo,
        phoneNo: this.device.alarmPhone
      }
      saveDeviceAlarmPhone(requestParams).then(response => {
